...
<%
    ...
    try {
        ...
        if (request.getParameter("salvar") != null) {
            ...
            st.execute("insert into cardapio(nm_prato, vl_valor, ds_prato, id_prato) values('" + nome + "', '" + valor + "', '" + desc + "', '" + cd + "')");
...
<html>
    <head>
        ...
        <title>Cadastro Espeto - Boi na Brasa</title>
    </head>
    <body background="http://1.bp.blogspot.com/-hPTt-K4vL1s/VhswvXNtugI/AAAAAAAAAXo/TluQCvDJyjA/s1600/tumblr_static_background.jpg">
        ...
        <h3 style="color:grey; text-align: center;">Cadastrar Espeto</h3> 
        <br>
    <center>
        <form >
            <table border="0">
                <tr>
                    ...
                    <td><input type="text" name="espeto_cd" placeholder="Código Espeto" required/></td>         
                </tr>
                <tr>
